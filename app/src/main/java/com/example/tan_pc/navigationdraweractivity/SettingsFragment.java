...
public class SettingsFragment extends Fragment {
    ...
    Spanned[] spannedStringsValves = new Spanned[8];
    ...
    public void InitializeComponent(View v) {
        ...
        //spinnerLoad(true);
        spinnerLoad(true);
        spinThems.setAdapter(new SpinnerAdapter(getContext())); //load Spinner theme
...
//Su kien settings:
        ...
        switch1.setOnClickListener(btnClickListener);
        switch1.setOnCheckedChangeListener(checkedChangedListenner);
        ...
        edt2Images.setOnFocusChangeListener(edtFocusChange);        // setOnFocusChangeListener
...
//                startActivity(Intent.createChooser(sendIntent, getResources().getText(R.string.send_to)));
    ...
    public void DisplaySettingsValue() {
        try {
            Cursor cursorCT = PROJECTDATABASE.GetData("SELECT * FROM " + TABLE_SETTINGS);
            while (cursorCT.moveToNext()) {
                spinValves.setSelection(cursorCT.getInt(1));
